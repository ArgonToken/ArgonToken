...
- [Building Dash](#building-argontoken)
...
```bash
    ...
    From https://github.com/argontokenpay/argontoken
...
[argontoken/gitian.sigs](https://github.com/argontokenpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
