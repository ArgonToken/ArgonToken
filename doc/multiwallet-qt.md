...
Only requiring some minor changes is argontoken.cpp.
...
Changes to argontoken.cpp
----------------------
argontoken.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
