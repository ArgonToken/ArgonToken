...
ArgonToken Core version 0.12.0 is now available from:
...
backwards-compatible with pre-0.12 versions of ArgonToken Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/argontoken/).
