...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 ARGONTOKEN tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = 0;
    CTransaction tx2;
    ...
    {
        CBlockIndex* pMNIndex = (*mi).second; // block for 1000 ARGONTOKEN tx -> 1 confirmation
