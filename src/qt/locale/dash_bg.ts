...
<context>
    ...
    <message>
        ...
        <translation>Съобщението което беше прикрепено към argontoken: URI ще бъде запазено с транзакцията за ваше сведение. Забележка: Това съобщение няма да бъде изпратено през Dash мрежата.</translation>
    </message>
    <message>
