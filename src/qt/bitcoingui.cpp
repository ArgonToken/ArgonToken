    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ArgonToken Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ArgonToken address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and argontoken: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ArgonToken Core"), this);
    aboutAction->setStatusTip(tr("Show information about ArgonToken Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ArgonToken"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ArgonToken addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ArgonToken addresses"));
    ...
    openAction->setStatusTip(tr("Open a argontoken: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ArgonToken Core help message to get a list with possible ArgonToken command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("ArgonToken Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ArgonToken network", "", count));
}
...
{
    QString strTitle = tr("ArgonToken Core"); // default title
