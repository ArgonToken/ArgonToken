...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ArgonToken Core"),
     ...
     * override -datadir in the argontoken.conf file in the default data directory
     * (to be consistent with argontokend behavior)
     */
    if(dataDir != getDefaultDataDirectory())
