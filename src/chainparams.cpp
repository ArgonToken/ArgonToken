...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("048240a7748a80a286b270ba126705ced4f2ca5a7847b3610ea3c06512150dade2a8512ed5ea86320824681fc0818f0ac019214973e677acd1244f5d0571fc5103");
        nDefaultPort = 60522;
        bnProofOfWorkLimit = ~uint256(0) >> 20;  // ArgonToken starting difficulty is 1 / 2^12
        nSubsidyHalvingInterval = 210000;
        nEnforceBlockUpgradeMajority = 750;
        nRejectBlockOutdatedMajority = 950;
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 0;
        nTargetTimespan = 24 * 60 * 60; // ArgonToken: 1 day
        nTargetSpacing = 2.5 * 60; // ArgonToken: 2.5 minutes
        ...
        base58Prefixes[PUBKEY_ADDRESS] = list_of( 23);                    // ArgonToken addresses start with 'A'
        base58Prefixes[SCRIPT_ADDRESS] = list_of( 16);                    // ArgonToken script addresses start with '7'
        base58Prefixes[SECRET_KEY] =     list_of(204);                    // ArgonToken private keys start with '7' or 'X'
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x02)(0xFE)(0x52)(0xF8); // ArgonToken BIP32 pubkeys start with 'drkv'
        base58Prefixes[EXT_SECRET_KEY] = list_of(0x02)(0xFE)(0x52)(0xCC); // ArgonToken BIP32 prvkeys start with 'drkp'
        base58Prefixes[EXT_COIN_TYPE]  = list_of(0x80000005);             // ArgonToken BIP44 coin type is '5'
...
public:
    CTestNetParams() {
        ...
        *///legacy seeders
        ...
        base58Prefixes[PUBKEY_ADDRESS] = list_of(139);                    // Testnet argontoken addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = list_of( 19);                    // Testnet argontoken script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY]     = list_of(239);                    // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x3a)(0x80)(0x61)(0xa0); // Testnet argontoken BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_SECRET_KEY] = list_of(0x3a)(0x80)(0x58)(0x37); // Testnet argontoken BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_COIN_TYPE]  = list_of(0x80000001);             // Testnet argontoken BIP44 coin type is '5' (All coin's testnet default)
