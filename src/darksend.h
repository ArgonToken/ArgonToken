...
{
public:
    /// Is the inputs associated with this public key? (and there is 1000 ARGONTOKEN - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of argontoken.
