...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 ARGONTOKEN:
        ...
        # Node0's balance should be starting balance, plus 500 ARGONTOKEN for another
        ...
        # Node0's total balance should be starting balance, plus 1000 ARGONTOKEN for 
