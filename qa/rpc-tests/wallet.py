...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 ARGONTOKEN, node2 has none. 
#   d) node0 sends 21 ARGONTOKEN to node2, in two transactions (11 ARGONTOKEN, then 10 ARGONTOKEN).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 21 ARGONTOKEN from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 ARGONTOKEN in block rewards plus fees, but
